...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StoreActivityLogRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controllers.PaymentTypeSwagger"
                                            }
                                        }
                                    }
                                }
        ...
        "/payments/{id}/items/attach-multiple": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Items to attach",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AttachMultipleItemsRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controllers.PaymentItemAttachedSwagger"
                                            }
                                        }
                                    }
                                }
        ...
        "/payments/{id}/items/not-attached": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controllers.ItemNotAttachedSwagger"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/controllers.PaymentItemSummarySwagger"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controllers.UptimeMonitorLogSwagger"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StoreUptimeMonitorLogRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controllers.UptimeMonitorSwagger"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StoreUptimeMonitorRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateUptimeMonitorRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controllers.ItemNotAttachedSwagger": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "integer"
        ...
        "controllers.PaymentItemAttachedSwagger": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "controllers.PaymentItemSummarySwagger": {
            "type": "object",
            "properties": {
                "formatted_amount": {
                    "type": "string"
        ...
        "controllers.PaymentTypeSwagger": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "controllers.UptimeMonitorLogSwagger": {
            "type": "object",
            "properties": {
                "checked_at": {
                    "type": "string"
        ...
        "controllers.UptimeMonitorSwagger": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "dto.AttachMultipleItemsRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AttachMultipleItemsItem"
                    }
                },
                "totalAmount": {
                    "type": "integer"
        ...
        "dto.StoreUptimeMonitorLogRequest": {
            "type": "object",
            "required": [
                "checked_at",
                "response_time_ms",
        ...
        "dto.UpdateUptimeMonitorRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "utils.UnauthorizedResponse": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "default": "Unauthorized: invalid token..."
                },
                "success": {
                    "type": "boolean",
                    "default": false
